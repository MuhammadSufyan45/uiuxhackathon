...
export default function Menu() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Overlay */}
            <div className={`sm:hidden fixed top-0 left-0 w-full h-full bg-white bg-opacity-70 backdrop-blur-sm z-30 transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            ...
            {isOpen && (
                <button
                    className="sm:hidden absolute top-5 right-5 z-40"
